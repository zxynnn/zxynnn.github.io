                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <!-- Tempat untuk mengubah warna button pada cust/pelanggan dan mengubah sesuai kebutuhan -->
                                        <div class="btn-group" role="group">
                                            <form>
                                                <a href="{{ route('customer.edit', $item->id) }}" class="btn btn-success btn-icon icon-left mr-2">
