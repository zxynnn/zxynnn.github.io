                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <img src="{{ !is_null($item) ? Storage::url($item->image) : url('assets/img/image_not_available.png') }}" class="rounded img-responsive" alt="{{ !is_null($item) ? $item->name : 'Company image' }}" width="100%" id="img-preview">
                                </div>
                                <div class="form-group">
