                                ...
                                @forelse ($items as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" onclick="printStruk('{{ route('transaction.struk', $item->transaction_code) }}')" class="btn btn-primary btn-icon icon-left">
                                                <i class="fas fa-print"></i> Struk
                                            </a>
                                            <script>
                                                function printStruk(url) {
                                                    window.open(url, 'mywindow', 'toolbar=0,scrollbars=1,statusbar=0,menubar=0,resizable=0,height=500,width=420');
                                                }
                                            </script>
