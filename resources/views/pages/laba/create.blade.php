    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <form action="{{ route('laba.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label>Rincian</label>
                                    <input type="text" class="form-control" name="beban" required>
                                </div>
                                <div class="form-group">
                                    <label>
                                        Jumlah Beban
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control currency" name="jumlah" id="jumlah-beban" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan <br />
